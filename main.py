...
async def startup_preload():
    ...
    # Note: Knowledge graphs (PrimeKG: 8.1M edges, Hetionet: 2.25M edges) use lazy loading
    # They load on-demand when a KG query endpoint is called
    # Background preloading disabled due to memory constraints on Railway
